...
IF Tikl_checkbox = 1 THEN
	...
	call write_variable_in_TIKL("Additional info for job at " & employer & " should have been received by now. The EVF received for this job should be on file. (TIKL auto-generated from EVF Received script).")
	transmit
	PF3
	'Success message
