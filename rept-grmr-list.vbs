...
name_of_script = "BULK - REPT-GRMR LIST.vbs"
start_time = timer
...
'DIALOGS----------------------------------------------------------------------
BeginDialog pull_REPT_data_into_excel_dialog, 0, 0, 231, 130, "Pull REPT/GRMR data into Excel dialog"
  ...
  Text 55, 5, 125, 10, "***PULL REPT GRMR INTO EXCEL***"
	...
	If has_content_check <> "        " then
		...
		Do
			...
			Do
				...
				EMReadScreen HRF_status, 2, MAXIS_row, 51		'Reading HRF status
				EMReadScreen revw_recd_date, 8, MAXIS_row, 64	'Reading review received date
