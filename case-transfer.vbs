...
'("02/28/2018", "Adding handling to allow cases to be filtered by recently closed programs as well.", "Casey Love, Hennepin County")
...
'("12/29/2017", "Coordinates for sending MEMO's has changed in SPEC/MEMO. Updated script to support change.", "Ilse Ferris, Hennepin County")
'("11/28/2016", "Initial version.", Script Created by Casey Love from Ramsey County)
'END CHANGELOG BLOCK =======================================================================================================
