...
Set fso_command = run_another_script_fso.OpenTextFile("I:\Blue Zone Scripts\Public assistance script files\Script Files\SETTINGS - GLOBAL VARIABLES.vbs")
...
call run_another_script(script_to_run)
