...
'("01/25/2018", "Added handling for all months. Previously script only allowed user to select from current month or current month plus 2.", "Ilse Ferris, Hennepin County")
