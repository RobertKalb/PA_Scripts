...
'("12/15/2016", "New script that will document the information about an appeal, and the appeal process.", "Charles Clark, Hennepin County")
'("12/12/2016", "Initial version.", "Charles Clark, Hennepin County")
'END CHANGELOG BLOCK =======================================================================================================
