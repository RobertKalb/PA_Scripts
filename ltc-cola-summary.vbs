...
'("11/29/2016", "Updated header of case note for eligibility to reflect the MAXIS footer month, not a static month of '01'.", "Ilse Ferris, Hennepin County")
'("11/29/2016", "Added header update for 2017 in case notes, and made this a variable year vs. hard coding this information into the script, and needing yearly updates.", "Ilse Ferris, Hennepin County")
