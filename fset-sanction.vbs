...
'("02/28/2018", "Added handling to only allow sanction to occur on cases with ABAWD coding of '10' or '06'.", "Ilse Ferris, Hennepin County")
'("12/30/2016", "Updated reason for sanction reasons for newly added 'reason for sanction' field on STAT/WREG. Also updated user dialogs to include sanction month/year instead of full sanction date.", "Ilse Ferris, Hennepin County")
