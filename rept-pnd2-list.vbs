...
'("12/10/2016", "Added IV-E and Child Care cases statuses to script, and checkbox option to add information about the last case note (date, x number, header of case note) to the spreadsheet. Added navigation so that the 'Case information' worksheet is the first worksheet that is visable to the user. Also added closing message informing user that script has ended sucessfully.", "Ilse Ferris, Hennepin County")
