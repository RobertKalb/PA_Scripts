...
EMReadScreen BENDEX_check, 47, 6, 28
If BENDEX_check = "BENDEX INFORMATION HAS BEEN STORED - CHECK INFC" then 
	...
	EMReadScreen is_right_line, 34, read_row, 28
	...
	' 04/21/2022 - Commenting this section - State has changed BNDX message appearing on DAIL screen.
	' 	New message will read MEMB XX BENDEX INFORMATION HAS BEEN STORED - CHECK INFC
	...
	' New 04/21/2022 - Adding Read for Refence Number
	EMReadScreen reference_number, 2, read_row, 25
	...
	' New 04/21/2022 - Commenting this code - the DAIL message is providing the MEMB number now instead of the SSN
