...
'("01/20/2017", "Added SWKR column. Updated BULK script to allow users to select what information is added (in addition to worker #, case #, client and FACI name).", "Ilse Ferris, Hennepin County")
'("01/03/2017", "Added FACI type column. Reordered GRH DOC amt, waiver type and AREP columns.", "Ilse Ferris, Hennepin County")
