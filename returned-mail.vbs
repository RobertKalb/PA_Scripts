...
warning_box = MsgBox("PLEASE READ!!" & chr(10) & chr(10) & "NEW!!! Script can now handle cases with an allowed forwarding address.  It will case note and TIKL for up-to 30 cases worth of returned mail.  Consult a supervisor if you have questions about returned mail policy." & _
