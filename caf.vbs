...
'("01/11/2017", "Adding functionality to offer a TIKL for 12 month contact on 24 month SNAP renewals.", "Charles Potter, DHS")
...
BeginDialog CAF_dialog_01, 0, 0, 451, 290, "CAF dialog part 1"
  ...
  ComboBox 230, 25, 95, 15, " "+chr(9)+"in-person"+chr(9)+"dropped off"+chr(9)+"mailed in"+chr(9)+"MNBenefits"+chr(9)+"faxed"+chr(9)+"emailed", how_app_was_received
